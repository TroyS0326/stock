...
OPERATOR_AUTH_ENABLED = os.getenv('OPERATOR_AUTH_ENABLED', '0') == '1'
OPERATOR_AUTH_TOKEN = os.getenv('OPERATOR_AUTH_TOKEN', '').strip()
OPERATOR_AUTH_HEADER = os.getenv('OPERATOR_AUTH_HEADER', 'X-Operator-Token').strip() or 'X-Operator-Token'
OPERATOR_AUTH_ALLOW_LOCALHOST = os.getenv('OPERATOR_AUTH_ALLOW_LOCALHOST', '1') == '1'
